<template>
    <div id="Plans">
            ...
            <div class="homeContent">            
                <div class="Header">Affordable<span class="grey"> and Scalable Plans</span>
                </div>
                <div class="Content">
                ...
                <div id="TableSection row">
                    <div class="col-md-6 offset-2">
                        <table id="plansTable">
                            ...
                            <tr> <td></td><td>Request</td><td>more</td><td>Information</td></tr>
                            <tr> <td>Unlimited Users</td><td> &#x2714</td><td>&#x2713</td><td> &#x2713</td></tr>
                            <tr> <td>Hosting and Backup</td><td> &#x2714</td><td>&#x2713</td><td> &#x2713</td></tr>
                            <tr> <td>Support and Maintentance</td><td>&#x2714</td><td>&#x2713</td><td> &#x2713</td></tr>
                            <tr> <td>Additional User On Boarding</td><td> &#x2714</td><td>&#x2713</td><td> &#x2713</td></tr>
                            <tr> <td>Collection Field Value Changes</td><td>&#x2714</td><td>&#x2713</td><td> &#x2713</td></tr>
                        </table>
                    </div>
                </div>
            </div>
            <div>
                <img id="imgTargetPilot" alt="target" src="../img/target.png"/>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <h1>Low Cost</h1>
                    <p>3-Month Pilot</p>
                    <router-link to="/plans"><button class="btnSeeDemo">Learn More</button></router-link>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <img src="../img/redglasses.jpg" alt="reading glasses">
                </div>
                <div class="col-md-6 ">
